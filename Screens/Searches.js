...
const pizzas = [
  ...
  { id: '3', name: 'Pizza Frango com Catupiry', price: 68,  image: 'https://www.sabornamesa.com.br/media/k2/items/cache/ada34cd2101afafaba465aad112ee3c1_XL.jpg'},
  { id: '3', name: 'Pizza Vegetariana', price: 80,  image: 'https://www.receiteria.com.br/wp-content/uploads/receitas-de-pizza-vegetariana-00.jpeg'},
  { id: '3', name: 'Pizza Havaiana ', price: 60,  image: 'https://minhasreceitinhas.com.br/wp-content/uploads/2017/06/1296_Pizza_havaiana-1200x800.jpeg'},
];


const hamburgers = [
  { id: '1', name: 'Hambúrguer Clássico', price: 20,  image: 'https://guiadacozinha.com.br/wp-content/uploads/2024/05/x-burguer-tradicional-768x619.jpg' },
  { id: '2', name: 'Cheeseburger', price: 40,  image: 'https://i.ytimg.com/vi/SvOx7tA_Cv8/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLAUi4DTtB9e2mnIAe3JoxUoj6nbNA' },
  { id: '3', name: 'Double Bacon', price: 43,  image: 'https://groundbeefrecipes.com/wp-content/uploads/double-bacon-cheeseburger-recipe-6.jpg' },
  { id: '3', name: 'Chicken Burguer', price: 30,  image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSV8_Q9_dhNnojwi4KjDfPCyRs3ceY0QqGD4g&s' },
  { id: '3', name: 'BBQ Burguer', price: 56,  image: 'https://realfoodbydad.com/wp-content/uploads/2019/07/Southern-BBQ-Burger-Real-Food-by-Dad-683x1024.jpg' },
  { id: '3', name: 'Hamburguer Vegano', price: 30,  image: 'https://img.irroba.com.br/fit-in/600x600/filters:fill(transparent):quality(80)/lojamrve/catalog/artes-dos-combos-com-precos-reajustados-201-6.png' },
];
